...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_comment'])) {
    ...
    echo "<script>window.location.href='post3.php';</script>";
    exit();
}
?>
<!DOCTYPE html>
  ...
  <style>
    ...
    * {
    ...
    .hero {
      ...
      width: 100%;
      height: 900px;
      background-image: url('https://sincerelyjules.com/wp-content/uploads/2024/03/Sincerely-jules-brown-knit-LV-Bag-hat-look.jpg');
...
<body>
  ...
  <!-- Text below image -->
  <div class="post-text">
    <p class="category">SELF CARE</p>
    <h2>8 QUICK & EASY<br><span>SELF CARE IDEAS</span></h2>
  </div>
<!-- Centered Image -->
  <div class="post-image">
    <img src="https://sincerelyjules.com/wp-content/uploads/2024/03/Sincerely-jules-brown-knit-LV-Bag-look-2.jpg" alt="Trench coat look">
  </div>

  <!-- Description -->
  <div class="post-description">
    <p>
      One goal that I believe we all should set is to prioritize time for yourself, regularly. This not only benefits your well-being but also enhances your overall productivity and happiness. In today’s fast-paced world it’s very easy to sacrifice time for yourself for social engagements or work related commitments.
      <br><br>
      It’s perfectly ok to sometimes consider trading them for a moment of relaxation and rejuvenation. For me, It’s essential to incorporate self-care into my daily routine and establish a balance between work and some ‘me’ time. Whether that looks like a day at the spa, having no plans, a day of reading or watching tv all day or even the simplest thing like getting myself flowers. 
      <br><br>
  ...
  <div class="slider-wrapper">
    <div class="slider-container">
      <div class="slider-item">
        <img src="https://m.media-amazon.com/images/G/01/Shopbop/p/prod/products/wgadb/wgadb4021911409/wgadb4021911409_1761320182878_2-0._QL90_UX282_.jpg" alt="Coach">
        <p>Louis Vuitton</p>
      </div>
      <div class="slider-item">
        <img src="https://media.thereformation.com/image/upload/f_auto,q_auto:eco,dpr_2.0/w_500/PRD-SFCC/1313949/COCOA/1313949.1.COCOA" alt="J.Crew">
        <p>Reformation</p>
      </div>
      <div class="slider-item">
        <img src="https://m.media-amazon.com/images/G/01/Shopbop/p/prod/products/leles/leles313142345e/leles313142345e_1757370390112_2-0._QL90_UX282_.jpg" alt="Anine Bing">
        <p>Lele Sadoughi</p>
      </div>
      <div class="slider-item">
        <img src="https://m.media-amazon.com/images/G/01/Shopbop/p/prod/products/lspec/lspec303911071c/lspec303911071c_q1_2-0._QL90_UX282_.jpg" alt="Levi’s">
        <p>Le Specs</p>
      </div>
      <div class="slider-item">
        <img src="https://m.media-amazon.com/images/G/01/Shopbop/p/prod/products/anine/anine309021cd2d/anine309021cd2d_1683836214690_2-0._QL90_UX282_.jpg" alt="Zara">
        <p>ANNIE BING</p>
      </div>
    </div>
  </div>
...
<div class="post-double-images">
  <img src="https://sincerelyjules.com/wp-content/uploads/2024/03/Sincerely-jules-brown-knit-LV-Bag-off-duty-look-1000x1500.jpg" alt="Outfit 1">
  <img src="https://sincerelyjules.com/wp-content/uploads/2024/03/Sincerely-jules-brown-knit-LV-Bag-look-1000x1500.jpg" alt="Outfit 2">
</div>

<!-- Tip Text Below Two Images -->
<div class="post-tip">
  <p>
    Here is a list of 8 quick & easy self care ideas:
    <br><br>
    <b>Read a book:</b> Escape into a different world and relax with a good book that interest you. Fiction or nonfiction, reading is a great way to unwind
    <br><br>
...
likeBtn.addEventListener('click', () => {
    ...
    fetch(`update_like.php?post_id=post3&action=${action}`)
        .then(res => res.json())
        .then(data => {
