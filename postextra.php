...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_comment'])) {
    ...
    echo "<script>window.location.href='postextra.php';</script>";
    exit();
}
?>
<!DOCTYPE html>
  ...
  <style>
    ...
    * {
    ...
    .hero {
      ...
      width: 100%;
      height: 900px;
      background-image: url('https://sincerelyjules.com/wp-content/uploads/2025/11/sincerely_jules_grey_frankie_coat_silver_adidas_the_row_bag_yellow_scarf_yellow_beanie.jpg');
...
<!-- Centered Image -->
  <div class="post-image">
    <img src="https://sincerelyjules.com/wp-content/uploads/2025/11/sincerely_jules_grey_frankie_coat_silver_adidas_the_row_bag_yellow_scarf_beanie.jpg" alt="Cozy coat look">
  </div>

  <!-- Description -->
  <div class="post-description">
    <p>
      A few weeks ago, we headed to Aspen to celebrate my husband’s birthday, and every time we visit, we fall in love with it all over again. There’s something so magical about Aspen—the fresh mountain air, the charming little shops, and that perfect mix of luxury and laid-back coziness. 
      <br><br>
      Whenever I’m there, I love taking full advantage of the chilly weather and dressing super cozy. Aspen temps call for warm layers and soft textures, so I reached for an oversized grey coat—my winter staple. I layered it over a simple long sleeve and added cozy accessories like a beanie and scarf to keep extra warm. Cute and practical!
      <br><br>
      To finish the look, I wore thick socks and these cool metallic Adidas sneakers I’ve been obsessed with. They’re comfy for walking around town but still add such a fun pop to a winter outfit.
    </p>
  </div>
<!-- ===== Product Slider ===== -->
  <div class="slider-wrapper">
    <div class="slider-container">
      <div class="slider-item">
        <img src="https://images.urbndata.com/is/image/FreePeople/101901247_007_b/?$a15-pdp-detail-shot$&fit=constrain&fmt=webp&qlt=80&wid=960" alt="Coach">
        <p>Veja</p>
      </div>
      <div class="slider-item">
        <img src="https://images.urbndata.com/is/image/FreePeople/82463712_001_d/?$a15-pdp-detail-shot$&fit=constrain&fmt=webp&qlt=80&wid=960" alt="J.Crew">
        <p>Free people</p>
      </div>
      <div class="slider-item">
        <img src="https://is4.revolveassets.com/images/p4/n/z/CITI-WJ1959_V1.jpg" alt="Anine Bing">
        <p>REVOLVE</p>
      </div>
      <div class="slider-item">
        <img src="https://img1.shopcider.com/product/1758015857000-Adb5kT.jpg?x-oss-process=image/resize,w_1400,m_lfit/quality,Q_80/interlace,1" alt="Levi’s">
        <p>Cider</p>
      </div>
      <div class="slider-item">
      <img src="https://assets.aritzia.com/image/upload/q_auto,f_auto,dpr_auto,c_fit,h_1920,w_1920/wi25-week-7-10" alt="Zara">
        <p>Aritzia</p>
      </div>
    </div>
  </div>
...
<div class="post-double-images">
  <img src="https://sincerelyjules.com/wp-content/uploads/2025/11/SINCERELUJULES_grey_frankie_coat_silver_adida_the_row_bag.jpg" alt="Outfit 1">
  <img src="https://sincerelyjules.com/wp-content/uploads/2025/11/sincerely_jules_grey_frankie_coat_silver_adidas_the_row_bag_look.jpg" alt="Outfit 2">
</div>
...
likeBtn.addEventListener('click', () => {
    ...
    fetch(`update_like.php?post_id=postextra&action=${action}`)
        .then(res => res.json())
        .then(data => {
