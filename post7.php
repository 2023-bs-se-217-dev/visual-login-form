...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_comment'])) {
    ...
    echo "<script>window.location.href='post7.php';</script>";
    exit();
}
?>
<!DOCTYPE html>
  ...
  <style>
    ...
    * {
    ...
    .hero {
      ...
      width: 100%;
      height: 900px;
      background-image: url('https://sincerelyjules.com/wp-content/uploads/2025/03/Tezza-4011.jpg');
...
<body>
  ...
  <div class="post-text">
    ...
    <h2>NYC MOMENTS<br><span>THINGS THAT<br>INSPIRED ME</span></h2>
  </div>
<!-- Centered Image -->
  <div class="post-image">
    <img src="https://sincerelyjules.com/wp-content/uploads/2025/03/Tezza-3447.jpg" alt="Trench coat look">
  </div>
  ...
  <div class="slider-wrapper">
    <div class="slider-container">
      <div class="slider-item">
        <img src="https://m.media-amazon.com/images/I/518XHq2miBL._AC_SX385_.jpg" alt="Coach">
        <p>ADE-WU</p>
      </div>
      <div class="slider-item">
        <img src="https://shop.mango.com/assets/rcs/pics/static/T8/fotos/S/87080629_92.jpg?imwidth=1920&imdensity=1&ts=1729771478886" alt="J.Crew">
        <p>MANGO</p>
      </div>
      <div class="slider-item">
        <img src="https://static.zara.net/assets/public/dde5/6b69/6e984379b388/ae0dacc4d61c/16724610624-e1/16724610624-e1.jpg?ts=1761582620591&w=433" alt="Anine Bing">
        <p>ZARA</p>
      </div>
      <div class="slider-item">
        <img src="https://is4.fwrdassets.com/images/p/fw/z/EIOF-WL28_V1.jpg" alt="Levi’s">
        <p>ELIOU</p>
      </div>
      <div class="slider-item">
        <img src="https://static.zara.net/assets/public/b08f/d358/489a46a6966c/8826c526724e/13148610700-e1/13148610700-e1.jpg?ts=1758092090444&w=433" alt="Zara">
        <p>ZARA</p>
      </div>
    </div>
  </div>
...
<div class="post-double-images">
  <img src="https://sincerelyjules.com/wp-content/uploads/2025/03/IMG_6823.jpg" alt="Outfit 1">
  <img src="https://sincerelyjules.com/wp-content/uploads/2025/03/Tezza-6720.jpg" alt="Outfit 2">
</div>
...
likeBtn.addEventListener('click', () => {
    ...
    fetch(`update_like.php?post_id=post7&action=${action}`)
        .then(res => res.json())
        .then(data => {
