...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_comment'])) {
    ...
    echo "<script>window.location.href='post6.php';</script>";
    exit();
}
?>
<!DOCTYPE html>
  ...
  <style>
    ...
    * {
    ...
    .hero {
      ...
      width: 100%;
      height: 900px;
      background-image: url('https://sincerelyjules.com/wp-content/uploads/2025/09/Sincerely_jules_posse_polka_dot_dress_the_row_look_11.jpg');
...
<body>
  ...
  <div class="post-text">
    ...
    <h2>HOW TO STYLE<br><span>A POLKADOT DRESS</span></h2>
  </div>


<!-- Centered Image -->
  <div class="post-image">
    <img src="https://sincerelyjules.com/wp-content/uploads/2025/09/Sincerely_jules_posse_polka_dot_dress_the_row_look_10.jpg" alt="Trench coat look">
  </div>

  <!-- Description -->
  <div class="post-description">
    <p>
     This summer’s fashion has felt so fun and flirty, and one of my favorite looks I’ve worn has to be this red polka dot dress. I’ve always been a fan of the whimsical pattern—it feels playful yet sophisticated, with that retro vibe I can’t help but adore. I was instantly drawn to the bold red hue and the flattering length, which made it an effortless standout.
      <br><br>
      Styling this little number was both easy and fun. I threw on my go-to classic oversized button-down over the dress, added bold jewelry, slipped on my favorite sunnies, and finished it off with a pair of low-heeled thong sandals—just the right amount of height without sacrificing comfort. The final look felt playful and polished all at once, perfect for a museum visit, an outdoor event, or anywhere your heart desires a touch of chic.
    </p>
  </div>
<!-- ===== Product Slider ===== -->
  <div class="slider-wrapper">
    <div class="slider-container">
      <div class="slider-item">
        <img src="https://cdn.saksfifthavenue.com/is/image/saks/0400022746145_BLACK?wid=534&hei=712&resMode=sharp2&op_usm=0.9,1.0,8,0&fmt=webp" alt="Coach">
        <p>TOTEME</p>
      </div>
      <div class="slider-item">
        <img src="https://shop.mango.com/assets/rcs/pics/static/T1/fotos/S/17011210_PL_B.jpg?imwidth=1920&imdensity=1&ts=1746187493086" alt="J.Crew">
        <p>MANGO</p>
      </div>
      <div class="slider-item">
        <img src="https://posse.com/cdn/shop/files/16_085337cb-82e4-45b2-8466-0b4b597c1b14_960x.jpg?v=1741653441" alt="Anine Bing">
        <p>POSSE</p>
      </div>
      <div class="slider-item">
        <img src="https://is4.fwrdassets.com/images/p/fw/45/TERX-WY42_V1.jpg" alt="Levi’s">
        <p>The Row</p>
      </div>
      <div class="slider-item">
        <img src="https://m.media-amazon.com/images/G/01/Shopbop/p/prod/products/shash/shash4308258624/shash4308258624_1735052570951_2-0._QL90_UX282_.jpg" alt="Zara">
        <p>SHASHI</p>
      </div>
    </div>
  </div>
...
<div class="post-double-images">
  <img src="https://sincerelyjules.com/wp-content/uploads/2025/09/Sincerely_jules_posse_polka_dot_dress_the_row_look_outfit-1000x1500.jpg" alt="Outfit 1">
  <img src="https://sincerelyjules.com/wp-content/uploads/2025/09/Sincerely_jules_posse_polka_dot_dress_the_row_look_black_heels_fit-1000x1500.jpg" alt="Outfit 2">
</div>

<!-- Tip Text Below Two Images -->
<div class="post-tip">
  <p>
    For the hair—there’s something so sultry about sweeping it up into a bun in the summer. It’s the perfect way to show off those sun-kissed shoulders. I especially love pairing an updo with bold jewelry—it instantly feels effortless while adding a fresh edge to the entire look.
...
likeBtn.addEventListener('click', () => {
    ...
    fetch(`update_like.php?post_id=post6&action=${action}`)
        .then(res => res.json())
        .then(data => {
